...
arr2_real = np.linspace(1.0, 10.0, size)
arr2_imag = np.linspace(1.0, 10.0, size)
device_cnt = 1
level = 4
...
print("real results match: " + str(np.allclose(arr1_real, arr_cpu_real)))
print("imag results match: " + str(np.allclose(arr1_imag, arr_cpu_imag)))
